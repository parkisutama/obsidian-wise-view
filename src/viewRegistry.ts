...
import type { BasesViewFactory, BasesAllOptions, BasesViewConfig, Command, HoverLinkSource } from 'obsidian';
...
/** Validates id format only; does not touch `factory` or any other view-instantiating field. */
