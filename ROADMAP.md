...
| Periodic Notes | [docs/specs/periodic-notes.md](docs/specs/periodic-notes.md) | [tasks/periodic-notes/plan.md](tasks/periodic-notes/plan.md) | [tasks/periodic-notes/todo.md](tasks/periodic-notes/todo.md) | Unblocked 2026-09-21 (Note Template is Done); awaiting maintainer review; Calendar-only, native (no plugin dependencies) |
